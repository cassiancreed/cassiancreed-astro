...
export async function GET(context: any) {
  ...
  const urls = ['', 'case-files/', 'explainers/', 'start-here/', 'books/', 'about/', 'trending/', 'case-solver/', 'forensic-tools/', 'safety/', 'support/', 'ai-al/', 'guides/', 'how-dna-remembers/', 'glossary/', 'how-forensic-genetic-genealogy-works/', 'codis-vs-forensic-genetic-genealogy/', 'how-othram-works-in-a-case/', 'is-fgg-evidence-or-just-a-lead/', 'is-forensic-genetic-genealogy-legal/', 'baby-jacob-round-lake-beach-genetic-genealogy/', 'court-calendar/', 'court-calendar-policy/', 'voir-dire-simulator/', 'the-trail/', 'mission/']
    .map(p => `${site}${p}`)
