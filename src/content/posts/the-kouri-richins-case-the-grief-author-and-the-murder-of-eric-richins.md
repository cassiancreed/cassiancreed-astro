...
tag: "Case Files"
featured: true
metaDescription: "Kouri Richins was convicted in 2026 of murdering her husband Eric with fentanyl, then writing a children's book about grief. The full, sourced case — appeal pending."
primaryKeyword: "Kouri Richins case"
secondaryKeywords:
  - "Eric Richins"
  - "Kouri Richins verdict"
  - "Kouri Richins fentanyl"
  - "Are You With Me Kouri Richins"
legalTier: "CONVICTED, appeal pending — state guilt as established but note the appeal wherever the case appears."
sources:
...
**Follow the case the right way.** We publish sourced, victim-first updates the day the record changes — including the appeal. [Subscribe free — get *The Jury Chess Game* →](https://cassiancreed.beehiiv.com/subscribe) — or [start here](https://cassiancreed.com/start-here/?utm_source=case_file&utm_medium=web&utm_campaign=kouri_richins&utm_content=cta_secondary) if you'd rather read first.
