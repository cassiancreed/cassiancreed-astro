...
relatedBook:
  key: jury-chess
  midCopy: "The Hernandez Melgar verdict turned on how jurors weighed circumstantial evidence against forensic ambiguity. Jury Chess explains that process from admitted evidence through verdict."
  endCopy: "If this case left you asking how a jury could convict without a homicide ruling or defendant DNA on the victim's neck, Jury Chess gives you the framework jurors are instructed to use."
---
...
<BookCTA book={frontmatter.relatedBook} placement="mid" />
