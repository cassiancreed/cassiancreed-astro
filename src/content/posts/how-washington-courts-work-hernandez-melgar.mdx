...
relatedBook:
  key: jury-chess
  midCopy: "The Hernandez Melgar case moved through Washington Superior Court, but jurisdiction is only the frame. Jury Chess explains what happens inside that frame as evidence reaches a criminal jury."
  endCopy: "Now that you know why this case belonged in Snohomish County Superior Court, Jury Chess takes the next step: how the trial record, instructions, and jury process produce a verdict."
---
