...
<label class="capf__label" for="em-lindsay-clancy-trial-2026-po-1">Email address</label>
<div class="capf__row">
<input class="capf__input" id="em-lindsay-clancy-trial-2026-po-1" type="email" name="email" required autocomplete="email" placeholder="Enter your email" />
...
<input type="hidden" name="utm_medium" value="post_cta" />
<input type="hidden" name="utm_campaign" value="lm_case_how-to-read-a-case" />
<label class="capf__label" for="em-lindsay-clancy-trial-2026-po-2">Email address</label>
<div class="capf__row">
<input class="capf__input" id="em-lindsay-clancy-trial-2026-po-2" type="email" name="email" required autocomplete="email" placeholder="Enter your email" />
<button class="capf__btn" type="submit">Get the free guide &rarr;</button>
</div>
</form>
</div>
