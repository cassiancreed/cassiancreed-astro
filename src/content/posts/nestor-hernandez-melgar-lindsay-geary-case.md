...
<label class="capf__label" for="em-nestor-hernandez-melgar-lind-1">Email address</label>
<div class="capf__row">
<input class="capf__input" id="em-nestor-hernandez-melgar-lind-1" type="email" name="email" required autocomplete="email" placeholder="Enter your email" />
...
<input type="hidden" name="utm_medium" value="post_cta" />
<input type="hidden" name="utm_campaign" value="lm_case_how-to-read-a-case" />
<label class="capf__label" for="em-nestor-hernandez-melgar-lind-2">Email address</label>
<div class="capf__row">
<input class="capf__input" id="em-nestor-hernandez-melgar-lind-2" type="email" name="email" required autocomplete="email" placeholder="Enter your email" />
<button class="capf__btn" type="submit">Get the free guide &rarr;</button>
</div>
</form>
</div>
...
<input type="hidden" name="utm_medium" value="post_cta" />
<input type="hidden" name="utm_campaign" value="lm_case_how-to-read-a-case" />
<label class="capf__label" for="em-nestor-hernandez-melgar-lind-3">Email address</label>
<div class="capf__row">
<input class="capf__input" id="em-nestor-hernandez-melgar-lind-3" type="email" name="email" required autocomplete="email" placeholder="Enter your email" />
<button class="capf__btn" type="submit">Get the free guide &rarr;</button>
</div>
</form>
</div>