...
relatedBook:
  key: jury-chess
  midCopy: "The Hernandez Melgar trial shows the exact problem jurors must solve: weigh competing narratives using only admitted evidence and the judge's instructions. Jury Chess explains that decision framework."
  endCopy: "This case is a real-world example of a jury resolving forensic ambiguity through the full trial record. Jury Chess explains how burdens, evidence rules, objections, and instructions shape that verdict."
---
...
<iframe loading="lazy" style={{ borderRadius: '12px' }} src="https://open.spotify.com/embed/show/3yAJhBsYBJcruN3lJAQ8db?theme=0" width="100%" height="352" frameBorder="0" allow="clipboard-write; encrypted-media; fullscreen; picture-in-picture" title="Listen: Cassian Creed — Daily Update episodes on this case"></iframe>
